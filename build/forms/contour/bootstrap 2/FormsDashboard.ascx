            ...
            <ItemTemplate>
                <li>
                    <% if (CompatibilityHelper.IsVersion7OrNewer)
                       {
                     %>      
                        <a target="_top" href="../#/contour/framed/<%# HttpUtility.UrlEncode("/umbraco/plugins/umbracocontour/editForm.aspx?guid=").Replace("%2f","%252F")%><%# ((Umbraco.Forms.Core.Form)Container.DataItem).Id %>"
                    class="form">
                    <%# ((Umbraco.Forms.Core.Form)Container.DataItem).Name %></a> <small><a target="_top" href="../#/contour/framed/<%# HttpUtility.UrlEncode("/umbraco/plugins/umbracocontour/editForm.aspx?guid=").Replace("%2f","%252F")%><%# ((Umbraco.Forms.Core.Form)Container.DataItem).Id %>">
                        Open form designer</a> <a target="_top" href="../#/contour/framed/<%# HttpUtility.UrlEncode("/umbraco/plugins/umbracocontour/editFormEntries.aspx?guid=").Replace("%2f","%252F")%><%# ((Umbraco.Forms.Core.Form)Container.DataItem).Id %>">
                            View entries</a> </small>
                     <%  }
                       else
                       { %>
                    <a href="plugins/umbracocontour/editForm.aspx?guid=<%# ((Umbraco.Forms.Core.Form)Container.DataItem).Id %>"
                    class="form">
